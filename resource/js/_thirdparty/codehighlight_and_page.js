/**
** JK注：来源：http://tool.114la.com/js/codehightlight.js ----没找到原作者。
** ======================================================================================
** 类名：CLASS_HIGHLIGHT
** 功能：语法高亮
** 示例：
...
Dom.ready(function(){
	W('textarea.code').forEach(
		function codeHLFun(el){
			...
			w.insertAdjacentHTML('beforebegin','<div class="example_btn_wrap"><input type=button value="运行示例'+(isJs?'JS':'HTML')+'" class="code_run" style="width:120px;"/> &nbsp; <input type=button value="修改示例" class="code_change" style="width:120px;"/></div>');
	...
	W('#ft.ft-qwrap').html('&copy; 2011&nbsp;QWrap&nbsp;&nbsp;&nbsp;<a href="http://www.qwrap.com/" target="_blank">QWrap首页</a>&nbsp;&nbsp;&nbsp;<a href="http://life.youa.com/" target="_blank">有啊生活</a>&nbsp;&nbsp;&nbsp;<a href="http://github.com/wedteam/qwrap" target="_blank">QWrap@github</a>');
